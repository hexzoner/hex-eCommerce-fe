  ...
  return (
    <div className="login-background">
      <form autoComplete="off" onSubmit={handleSubmit(onSubmit)} className="min-h-screen flex flex-col gap-6 justify-center items-center">
        <div className="flex flex-col gap-5 justify-center items-center bg-white max-w-lg m-auto pt-8 pb-8 px-16 border-[1.5px] border-black border-opacity-60">
          <p>Create new account</p>
          <div>
            <label className={inputMarkup}>
          ...
          <div>
            <label htmlFor="password" className={inputMarkup}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="h-4 w-4 opacity-70">
                <path
                  fillRule="evenodd"
          ...
          <div>
            <label htmlFor="confirmPassword" className={inputMarkup}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="h-4 w-4 opacity-70">
                <path
                  fillRule="evenodd"
                  d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z"
            ...
            {errors.confirmPassword && (
              <p className="text-error text-xs text-left mt-1 ml-2 absolute">{errors.confirmPassword.message?.toString()}</p>
            )}
          </div>
