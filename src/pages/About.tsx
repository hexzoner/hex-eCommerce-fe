  ...
  return (
    <div className={mainMakrupColors}>
      <div className="min-h-screen flex flex-col justify-center items-center text-2xl gap-8">
        ...
        <p className="text-lg">Admin can user manage products, categories, colors, sizes, orders and other options in admin panel part of the websiite.</p>
        <p className="text-lg">Users can register, browse products, add them to the wishlist and to the cart. After logging in users can purchase products.</p>
